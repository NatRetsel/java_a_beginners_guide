/*
 * This project enhances the Queue class by giving it two additional constructors. The first will construct a new queue from another
 * queue. The second will construct a queue, giving it initial values.
 */
class Queue {
